export default [
    { label: 'Schedule', route: 'schedule', icon: 'schedule-icon', routesToMatch: ['schedule'] },
    ...
    { label: 'Recipes', route: 'recipes', icon: 'recipe-icon', routesToMatch: ['recipes', 'create-recipe', 'edit-recipe', 'view-recipe'] },
